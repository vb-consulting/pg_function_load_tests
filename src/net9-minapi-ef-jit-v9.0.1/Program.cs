...
Console.WriteLine($"Npgsql.EntityFrameworkCore.PostgreSQL:      {System.Reflection.Assembly.GetAssembly(typeof(DbContext))?.GetName()?.Version?.ToString()}");

var builder = WebApplication.CreateSlimBuilder(args);
builder.WebHost.UseUrls("http://0.0.0.0:5502");
